...
class AllSets_Trainer:
    def __init__(self):
        ...
        args = argparse.Namespace(
            ...
            lr=0.001,
            wd=0.0,
            epochs=10, # Allsets use 500 epochs, we changed this to 1000 since we use 1000 for HNHN
        ...
        eval_func = self.eval_acc
        
        model = self.parse_method(args, data)
        ...
        for run in tqdm(range(args.runs)):
            ...
            for epoch in range(args.epochs):
                ...
                optimizer.step()
        #         Evaluation part
                result = self.evaluate(model, data, split_idx, eval_func)
    ...
    @torch.no_grad()
    def evaluate(self, model, data, split_idx, eval_func, result=None):
    ...
    def parse_method(self, args, data):
        if args.LearnMask:
